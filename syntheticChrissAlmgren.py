...
TOTAL_SHARES2 = 1                                              # Total number of shares to sell
STARTING_PRICE = 50                                                  # Starting price per share
LLAMBDA1 = 1e-4                                                      # Trader's risk aversion
LLAMBDA2 = 1e-6
...
class MarketEnvironment():
    ...
    def __init__(self, randomSeed = 0,
        ...
        self.shares_remaining2 = 0 #self.total_shares2
...
#             sharesToSellNow = min(self.shares_remaining * action, self.shares_remaining)
        ...
        if self.transacting1 or self.transacting2:
            ...
            # adjusted_reward = (reward1 + reward2)/2  ## Cooperation
            # reward1 = adjusted_reward
            # reward2 = adjusted_reward

            # if reward1 > reward2:  ## Competition
            #     reward2 -= reward1
            # else:
            #     reward1 -= reward2
